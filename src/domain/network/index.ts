...
export { NETWORK_DIMENSIONS, NETWORK_DIMENSION_VALUES, getRequiredFieldsForNetworkDimension, type BipartiteDimensionConfig, type NetworkDimension } from "./dimensions.js";
